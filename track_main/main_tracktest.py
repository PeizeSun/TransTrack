...
from models import save_mottest
...
def main(args):
    ...
    dataset_train = build_dataset(image_set='trainall', args=args)
    ...
    if args.eval:
        ...
        if args.output_dir:
            ...
            if res_tracks is not None:
                ...
                # save mot results.
                save_mottest(res_tracks, args.output_dir, video_to_images, video_names)
